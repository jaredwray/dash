...
2) Use **Node.js 24** (Active LTS) and **pnpm**. From the repo root:
	- `pnpm install`
	- `pnpm test`
	- `pnpm typecheck`
	- If you changed the feature set, update the checklist in [README.md](README.md).
...
9) Once the pull request has been reviewed, those with write access to the branch will be able to merge your changes into the `dash` repository.
