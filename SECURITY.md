...
- All changes land through pull requests — direct pushes to `main` are blocked, and merging requires passing status checks (`node-24`, `zizmor`).
...
- Workflows are security-linted with zizmor on every PR.
